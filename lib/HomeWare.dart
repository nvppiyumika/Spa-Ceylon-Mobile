...
class HomeWarePage extends StatefulWidget {
  // Renamed here
  const HomeWarePage({super.key});

  @override
  _HomeWarePageState createState() => _HomeWarePageState(); // Renamed here
}
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/homeware.png', // Updated image
                  width: 80,
                  height: 80,
                ),
              ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Cardamom Rose - Fine Porcelain - Coffee Mug', // Updated product
